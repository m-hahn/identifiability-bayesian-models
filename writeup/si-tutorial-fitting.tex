...
\citet{hahn2024unifying} mitigate overfitting in the shapes of prior and encoding by adding a regularization term penalizing the squared distances between $\alpha(\theta_i), \alpha(\theta_{i+1})$ and similarly for $\beta$, modulated with a regularization strength $\lambda$ that is set by the user.
