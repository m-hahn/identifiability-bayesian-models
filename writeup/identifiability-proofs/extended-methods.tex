...
The proofs of Theorems~3.2--3.4, provided in \correspondingSIVersion{SI Appendix S2.5 and S2.6}{Sections~\ref{sec:proof-theorem-2} and \ref{sec:theorems-two-levels}}, recover model components using the Method of Moments, %
