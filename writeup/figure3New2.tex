...
\node (topPlot) {\includegraphics[width=0.55\textwidth]{figures/CounterfactualModel_VIZ_Components_Fig2.py_5_UNIFORM_STEEPPERIODIC_2_0_10.0_180.pdf}};
...
\node[right=0cm of topPlot.north, anchor=south,  yshift=0.5cm, align=center] (gtlabel) {\large Ground truth (L$^2$ loss)};
...
\node[below=0.8cm of topPlot.south, anchor=north, xshift=-0.5cm] (l0Label) {\large L$^0$ loss};
...
\node[right=6cm of l0Label, anchor=center] (l2Label) {\large L$^2$ loss};
...
\node[below=0.9cm of l0Plot.south, anchor=north] (l4Label) {\large L$^4$ loss};
...
\node[right=6cm of l4Label.east, anchor=center] (l8Label) {\large L$^8$ loss};
