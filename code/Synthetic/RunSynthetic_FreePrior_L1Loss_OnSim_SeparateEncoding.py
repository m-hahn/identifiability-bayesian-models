assert False, "not sure if more models here need to be run? for now adding this"
...
assert noiseConditions == [2,3,4,5] # not a hard constraint, but here for sanity check
