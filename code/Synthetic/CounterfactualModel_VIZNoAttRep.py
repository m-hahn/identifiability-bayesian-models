...
def model(grid):
  ...
  for iteration in range(1):
   ...
   if iteration % 100 == 0:
     gridspec = dict(width_ratios=[1,0.4,1,0.4,0,0,1,0,0])
     figure, axis = plt.subplots(1, 9, figsize=(0.97*0.8*0.9*0.76*1.3*0.8*5/6*10,0.8*0.9*0.8*2), gridspec_kw=gridspec)
     plt.tight_layout()
