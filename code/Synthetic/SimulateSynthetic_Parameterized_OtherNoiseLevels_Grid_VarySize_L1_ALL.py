...
for exponent in [1]: # P = 1
    for dataSize in [2000, 5000, 10000, 20000, 40000]:
        for NoiseLevels_set in power_set([2, 3, 4, 5]):
            ...
            subprocess.call(["python3", "SimulateSynthetic_Parameterized_OtherNoiseLevels_Grid_VarySize.py", str(exponent), "0", "10.0", "180", str(dataSize), PRIOR, ENCODING, NoiseLevels])
