...
The main script is:
* [basic script for fitting model (Losses with p >= 2)](RunSynthetic_FreePrior_CosineLoss_OnSim.py) (see [more here](../README.md#Instructions))
...
## Batch script for Figure 4 (and associated figures in SI Appendix)
