...
def model(grid):
  ...
  for iteration in range(10000000):
   ...
   regularizer_total = regularizer1
   ...
   optim.step()
   if iteration % 10 == 0:
     print("Run for ", iteration, "Iterations.", loss, init_parameters["sigma_logit"], "mixture_logit", init_parameters["mixture_logit"], "log_motor_var", init_parameters["log_motor_var"], torch.exp(-init_parameters["sigma2_stimulus"]), learning_rate)
